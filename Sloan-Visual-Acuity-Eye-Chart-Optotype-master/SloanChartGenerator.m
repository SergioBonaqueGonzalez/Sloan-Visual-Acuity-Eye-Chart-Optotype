...
%     SloanChartGenerator(0.33,10*1e-6,[1200 1200],(0.7:0.1:1.6),7)
% 
% 
...
% TODO list:
%       - Properly allocate memory for sideTextMat and letterMat to improve code
%       performance


function SloanChartGenerator(varargin)
...
for i = 1:length(Truerange)
    ...
    letterCheck = []; %letters already generated
...
%display resolution due to rounding error
...
% Write the eyechart to a .tif file
